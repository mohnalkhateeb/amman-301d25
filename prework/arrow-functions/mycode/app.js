...
// TODO: Uncomment the following line of code to see the output in the browser console
 ...
 //arrow sum
 const arrowSum = (a, b, c, d) => {return a + b + c + d;}
...
const arrowObjectList = ()=> {return {key1: 'value1', key2: 'value2', key3: 'value3',}}
console.log(arrowObjectList())
...
// TODO: Uncomment the following line of code to see the output in the browser console
 ...
 const arrowMessage = name =>  {return `Hello, ${name}!`;}
...
//  const arrowStudent = (name, age, hometown) => {
//   this.name = name;
//   this.age = age;
//   this.hometown = hometown;
// };
// let joe1 = new arrowStudent('Joe', 'Schmoe', 100);
// console.log(joe1)
...
// joe object from student 
// 2. What is "this" when joe.scopeArrow() is invoked?
// window object (web page )
// 3. Explain why "this" is different when an arrow function is used.
// becuse the defult value of this in arrow function is DOM
